...
export default (db) => {
    const controller = {
        ...
        createMessageAndTags(data, unstructuredReply = false, poll = undefined, surpriseMe = false, metadata = undefined) {
            var tags = [];
            ...
            return controller.createMessage(data, { unstructuredReply, poll, surpriseMe, metadata }).then((message) => {
